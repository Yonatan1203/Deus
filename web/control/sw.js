const CACHE = 'deus-control-v4';
const SHELL = ['/', '/app.css', '/app.js', '/dom.js', '/icons.js', '/ui.js', '/views/chat.js', '/views/agents.js', '/views/wardens.js', '/views/mcps.js', '/views/sessions.js', '/views/groups.js', '/views/tasks.js', '/views/channels.js', '/views/memory.js', '/manifest.webmanifest', '/fonts/Geist-latin.woff2', '/fonts/GeistMono-latin.woff2', '/icons/icon.svg', '/icons/icon-192.png', '/icons/icon-512.png'];
